...
namespace net.seabay.polarion.Session {
    ...
    public interface SessionWebService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        net.seabay.polarion.Session.logInWithTokenResponse logInWithToken(net.seabay.polarion.Session.logInWithTokenRequest request);
    ...
    public partial class SessionWebServiceClient : System.ServiceModel.ClientBase<net.seabay.polarion.Session.SessionWebService>, net.seabay.polarion.Session.SessionWebService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        net.seabay.polarion.Session.logInWithTokenResponse net.seabay.polarion.Session.SessionWebService.logInWithToken(net.seabay.polarion.Session.logInWithTokenRequest request) {
            return base.Channel.logInWithToken(request);
        }
        
        public void logInWithToken(string mechanism, string username, string token) {
            net.seabay.polarion.Session.logInWithTokenRequest inValue = new net.seabay.polarion.Session.logInWithTokenRequest();
            inValue.mechanism = mechanism;
            inValue.username = username;
            inValue.token = token;
            net.seabay.polarion.Session.logInWithTokenResponse retVal = ((net.seabay.polarion.Session.SessionWebService)(this)).logInWithToken(inValue);
        }
