...
namespace PolarionReports.Models
{
    public class TooltipReview
    {
        ...
        public string WorkitemApproversNotWaiting;
        public string RejectedWorkItemsWithApprovers;
        public string RejectedWorkItemsWithoutApprovers;
        ...
        public TooltipReview()
        {
            ...
            RejectedWorkItemsWithoutApprovers = Tooltips.ReviewRejectedWorkItemsWithoutApprovers;
            WorkitemApproversNotWaiting = Tooltips.ReviewWorkitemApproversNotWaiting;
