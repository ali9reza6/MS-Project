...
namespace PolarionReports.App_GlobalResources {
    ...
    // To or remove a member, edit your .ResX file then rerun ResGen
    ...
    public class Tooltips {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Rejected requirements without Approvers:
        ///- Previously, Approvers were deleted, if requirements had been rejected for avoiding unnecessary unintentional reviews.
        ///- Currently, the following rule applies: If the reject of a requirement has (potential) impact on linked WorkItems (e.g. test cases or child requirements), additional Approvers of (potentially) affected disciplines shall be assigned, if necessary; the Approval Status of all Approvers shall be set to “Waiting” (Review with Impact Analysis is requir [rest of string was truncated]&quot;;.
        /// </summary>
        public static string ReviewRejectedWorkItemsWithoutApprovers {
            get {
                return ResourceManager.GetString("ReviewRejectedWorkItemsWithoutApprovers", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Rejected requirements with Approval Status not “Waiting”: At least one Approver has reviewed the requirement and has changed the Approval Status. If the requirement has been disapproved, the requirement will also be listed in “Review results/WorkItems with Approval Status “Disapproved””.
        ///Required action:
        ...
        ///·         Approval Status = “Disappr [rest of string was truncated]&quot;;.
        /// </summary>
        public static string ReviewWorkitemApproversNotWaiting {
            get {
                return ResourceManager.GetString("ReviewWorkitemApproversNotWaiting", resourceCulture);
            }
        }
